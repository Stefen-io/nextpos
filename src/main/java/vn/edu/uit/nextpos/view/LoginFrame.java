    ...
    private void handleLogin(ActionEvent e) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    ...
                    "Không thể kết nối MySQL.\n"
                            + ex.getMessage()
                            + "\n\nKiểm tra app.db.password trong application.properties\n"
                            + "hoặc chạy: mvn exec:java -Dapp.db.password=<mật-khẩu>",
        ...
        if (emp != null) {
            ...
            try {
                ...
                vn.edu.uit.nextpos.models.UserSession session = new vn.edu.uit.nextpos.models.UserSession();
                ...
                new vn.edu.uit.nextpos.dao.UserSessionDAO().createSession(session);
