 ...
 *
 * Các icon nên được đặt tại: {@code src/main/resources/nextpos/icons/}
 *
 * Ví dụ:
 * <pre>
...
public class IconUtil {
    ...
    /**
     * Tải icon PNG từ thư mục {@code /nextpos/icons/} trong resources và scale
    ...
    public static ImageIcon loadPng(String fileName, int size) {
        URL url = IconUtil.class.getResource("/nextpos/icons/" + fileName);
        if (url == null) {
    ...
    /**
     * Tải icon SVG từ thư mục {@code /nextpos/icons/} sử dụng FlatLaf.
     *
    ...
    public static Icon loadSvg(String fileName, int size) {
        return new FlatSVGIcon("nextpos/icons/" + fileName, size, size);
    }
}
