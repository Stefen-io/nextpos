package vn.edu.uit.nextpos.ui.panel;
...
import vn.edu.uit.nextpos.ui.dialog.CategoryDialog;
import vn.edu.uit.nextpos.ui.dialog.ProductFormDialog;
import vn.edu.uit.nextpos.ui.table.ProductButtonEditor;
import vn.edu.uit.nextpos.util.QRCodeUtil;
...
public class ProductPanel extends JPanel {
    ...
    public static class ImageRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
            ...
            if (value != null) {
                String path = AppPaths.picturePath(value.toString());
